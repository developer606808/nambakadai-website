...
const SPAM_PATTERNS = [
  /^test\d+@/i,     // test emails like test1@, test123@ (but allow test@)
  /^admin\d+@/i,    // admin emails like admin1@, admin123@ (but allow admin@)
  /^noreply\d+@/i,  // noreply emails like noreply1@
  /^no-reply\d+@/i, // no-reply emails like no-reply1@
  /^support\d+@/i,  // support emails like support1@ (but allow support@)
  /^info\d+@/i,     // info emails like info1@ (but allow info@)
  /^contact\d+@/i,  // contact emails like contact1@ (but allow contact@)
